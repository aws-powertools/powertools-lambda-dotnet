...
internal class PowertoolsLambdaContext
{
    ...
    internal static bool Extract(AspectEventArgs eventArgs)
    {
        ...
        var context = (ILambdaContext)eventArgs.Args.FirstOrDefault(x => x is ILambdaContext);
        ...
        var pt = (ILambdaContext)eventArgs.Args[1];
        Instance.AwsRequestId = pt.AwsRequestId;
        Instance.FunctionName = pt.FunctionName;
        Instance.FunctionVersion = pt.FunctionVersion;
        Instance.InvokedFunctionArn = pt.InvokedFunctionArn;
        Instance.LogGroupName = pt.LogGroupName;
        Instance.LogStreamName = pt.LogStreamName;
        Instance.MemoryLimitInMB = pt.MemoryLimitInMB;
