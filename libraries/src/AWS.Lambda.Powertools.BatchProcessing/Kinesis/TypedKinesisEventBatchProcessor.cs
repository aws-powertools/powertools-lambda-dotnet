...
public class TypedKinesisEventBatchProcessor : KinesisEventBatchProcessor, ITypedBatchProcessor<KinesisEvent, KinesisEvent.KinesisEventRecord>
{
    ...
    /// </summary>
    private sealed class TypedRecordHandlerWrapper<T> : TypedRecordHandlerWrapperBase<KinesisEvent.KinesisEventRecord, T>
    {
        ...
        protected override string GetDeserializationErrorMessage(KinesisEvent.KinesisEventRecord record, DeserializationException ex)
        {
            return $"Failed to deserialize Kinesis record '{record.Kinesis.SequenceNumber}' to type '{typeof(T).Name}'. See inner exception for details.";
        }
    }
    ...
    /// </summary>
    private sealed class TypedRecordHandlerWithContextWrapper<T> : TypedRecordHandlerWithContextWrapperBase<KinesisEvent.KinesisEventRecord, T>
    {
