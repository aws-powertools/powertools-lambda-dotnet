...
{
    /// <summary>
    /// Module initializer for AWS Lambda Powertools Parameters library.
    /// This class is responsible for setting up the execution environment when the module is loaded.
    /// </summary>
    internal static class ModuleInitializer
    {
        /// <summary>
        /// Initializes the AWS Lambda Powertools Parameters module.
        /// This method is automatically called when the module is loaded by the .NET runtime.
        /// It sets the POWERTOOLS_UTILITY environment variable to "Parameters" to enable
