...
public abstract class ParameterProvider<TConfigurationBuilder> : ParameterProvider
    where TConfigurationBuilder : ParameterProviderConfigurationBuilder
{
    ...
    public new TConfigurationBuilder WithMaxAge(TimeSpan maxAge)
    {
    ...
    /// </summary>
    /// <returns>Provider Configuration Builder instance</returns>
    public new TConfigurationBuilder ForceFetch()
    {
    ...
    /// <returns>Provider Configuration Builder instance</returns>
    public new TConfigurationBuilder WithTransformation(Transformation transformation)
    {
    ...
    /// <returns>Provider Configuration Builder instance</returns>
    public new TConfigurationBuilder WithTransformation(ITransformer transformer)
    {
    ...
    /// <returns>Provider Configuration Builder instance</returns>
    public new TConfigurationBuilder WithTransformation(string transformerName)
    {
